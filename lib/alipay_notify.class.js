...
AlipayNotify.prototype.getResponse = function(notify_id, callback){
    ...
    if(transport == 'https') {
        ...
        core_funcs.getHttpsResponseGET(veryfy_url, this.alipay_config['cacert'],this.alipay_config['cakey'], callback); 
    }
    else {
        veryfy_url = this.http_verify_url + "partner=" + partner +  "&notify_id=" + notify_id;
        core_funcs.getHttpResponseGET(veryfy_url, callback); 
    }
}
